        ...
        resources: {
            ...
            ru: {
                ...
                tnsn_send_online: {
                    ...
                    contract_addr_placeholder: 'Адрес смарт-контракта',
                    btn_find_tokens: 'Найти',
                    dscr_find_tokens: "Будет найден токен и добавлен в поле 'Тип'. Токен из смарт-контракта. Контракт из блока с номером 'Адрес контракта'.",
                    tkn_type_label: 'Тип',
                ...
                wallet_create: {
                    main: {
                        header: 'Создание нового кошелька',
                        description1: 'Будет создан новый кошелёк - для управления токенами',
                        description2: 'и новый ключ - для доступа к кошельку.',
                        btn_create: 'Создать новый кошелёк',
                    },
                    file: {
                        header: 'Сохранение файла',
                        description1: "Сохраните ваш <span class='label label-danger'>файл-хранилище ключа</span>",
                        btn_download: 'Скачать файл (UTC / JSON)',
                        btn_continue: 'Я понимаю. Продолжить',
                        help1_header: 'Не теряйте',
                        help1_text: 'Если потеряете файл - его невозможно будет восстановить.',
                        help2_header: 'Никому не давайте файл',
                        help2_text: 'Ваши средства будут украдены, если вы используете этот файл на вредоносном/фишинговом сайте.',
                        help3_header: 'Сделайте копию.',
                        help3_text: 'Обезопасьте его, как миллионы долларов, которые он может когда-нибудь стоить.',
                    },
                    key: {
                        header: 'Сохранение ключа',
                        description1: "Сохраните ваш <span class='label label-danger'>Приватный Ключ</span>",
                        btn_print: 'Распечатать на бумаге',
                        btn_login: 'Узнать мой адрес',
                        help1_header: 'Не теряйте',
                        help1_text: 'Если потеряете файл - его невозможно будет восстановить.',
                        help2_header: 'Никому не давайте файл',
                        help2_text: 'Ваши средства будут украдены, если вы используете этот файл на вредоносном/фишинговом сайте.',
