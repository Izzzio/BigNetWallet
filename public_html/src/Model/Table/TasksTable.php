...
class TasksTable extends AppTable
{
    ...
    const FLAGS = ['new' => 'new', 'pending' => 'pending', 'finished' => 'finished'];
    const FLAG_NEW = self::FLAGS['new'];
    const FLAG_PENDING = self::FLAGS['pending'];
    const FLAG_FINISHED = self::FLAGS['finished'];
