    ...
    <main class="cab-main">
        <div class="cab-container">
            ...
            <section class="cab-sec">
                <h2 class="cab-sec-header"><?= __('Please enter your email to continue') ?></h2>
                    ...
                    <div class="cab-copylink__wrap">
                        <form method="post">
                            <div class="cab-copylink__form">
                                ...
                                <input type="text" id="email" name="email" class="input cab-copylink__input" placeholder="<?= __('Email') ?>">
