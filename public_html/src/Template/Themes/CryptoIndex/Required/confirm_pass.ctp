    ...
    <main class="cab-main">
        <div class="cab-container">
            ...
            <section class="cab-sec">
                <h2 class="cab-sec-header"><?= __('Please, input you password for continue') ?></h2>
                <div class="cab-blc cab-copylink">
                    <div class="cab-copylink__wrap">
                        ...
                        <div class="cab-copylink__form">
                                ...
                                <input type="password" id="pass" name="pass" class="cab-copylink__input" placeholder="<?= __('Password') ?>">
