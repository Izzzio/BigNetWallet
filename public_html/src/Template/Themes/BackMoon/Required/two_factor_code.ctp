                ...
                <div class="container">
                    ...
                    <div class="">
                        <div class="lk-block top-block">
                            <h3><?= __('Please enter 2FA security code') ?></h3><br>
                            <form method="post" class="accountForm">
                                <input name="_CSRF" type="hidden" value="<?= \App\Lib\Crypt::ecrypt('CSRF_' . rand()) ?>">
                                <br />
                                <div class="form-group">
                                    <label for="code"><?= __('Code from app') ?></label>
                                    <input type="text" id="code" name="code" class="input-field">
                                </div>
                                <input type="submit" class="btn btn-dark-green" style="margin-top: 25px" value="<?= __('Send') ?>">
                            </form>
                        </div>
                    </div>
                </div>
