...
<div class="site" id="site">
            ...
            <div class="lk-main-list row">
                <div class="lk-block main-block left-block">
                    <div class="main-block-inner">
                        <h2 class="main-block-title"><?= __('How to buy') . ' ' . \App\Lib\Misc::tokenName() ?> </h2>
                        ...
                        <div class="main-block-step">
                            1. <?= __('Tokens amount') ?> <span><?= __('Payment currency') ?>:</span>
                        </div>
	...
	45.63,75.8 0.375,38.087 45.63,0.375 "/>
            ...
            <div class="lk-block bottom-block referalBlock">
                <div class="referal-title"><?= __('Referal link') ?></div>
                ...
                <br>
                <br>
                <div class="referal-title"><?= __('Your referals') ?></div>
                <?php if (count($refs) > 0) { ?>
