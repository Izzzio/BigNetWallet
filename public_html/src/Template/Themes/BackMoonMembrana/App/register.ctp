...
<head>
    ...
    <link rel="stylesheet"
          href="<?= URL_PREFIX . APP_THEME_BASE ?>/bootstrap/datepicker/css/bootstrap-datepicker.min.css">
                ...
                <fieldset class="form-step form-step1 active">
                    ...
                    <div class="checkbox checkbox3">
                        ...
                        <label class="checkbox-label" for="check3">
                            ...
                            <div class="checkboxText"><?= __('I agree with') ?></div>
                            <a href="<?= \App\Lib\Misc::policyUrl() ?>"
                    ...
                    <div class="checkbox checkbox1">
                        ...
                        <label class="checkbox-label" for="check1">
                            ...
                            <div class="checkboxText"><?= __('I agree with') ?></div>
                            <a href="<?= \App\Lib\Misc::whitepaperUrl() ?>"
                ...
                <?php if (\Cake\Core\Configure::read('App.enableUserData')) { ?>
                    <fieldset class="form-step form-step2">
                        ...
                        <div class="input-block">
                            ...
                            <input class="input-field <?= \Cake\Core\Configure::read('App.enableSaftDataFilling') ?
                                'disabled' : '' ?>" type="text" name="phone" id="address" required>
                        </div>
                        <div class="checkbox checkbox4">
                            <input id="check4" class="checkbox-field" type="checkbox" required>
                            <label class="checkbox-label" for="check4">
								<span>
								</span> I've filled correct data</label>
                        </div>
                        <br>
                        <div class="input-block">
                            <label class="RBcontainer">I am not a US, Canada or China citizen
                                <input type="radio" checked="checked" value="good" name="citizenship">
                                <span class="RBcheckmark"></span>
                            </label>
                        </div>
                        <div class="input-block">
                            <label class="RBcontainer">I am China citizen
                                <input type="radio" value="china" name="citizenship">
                                <span class="RBcheckmark"></span>
                            </label>
                        </div>
                        <div class="input-block">
                            <label class="RBcontainer">I am US or Canada citizen
                                <input type="radio" value="usa" name="citizenship">
                                <span class="RBcheckmark"></span>
                            </label>
                            <div class="checkbox checkbox5" style="display:none;">
                                <input id="check5" class="checkbox-field" type="checkbox">
                                <label class="checkbox-label" for="check5">
								<span>
								</span> I am accredited investor</label>
                            </div>
                        ...
                        <div id="restrictionText" style="display: none">* Due to regulations you cannot participate in
                            public PREsale. For more details please send an email to invest@membrana.io
                        </div>
                    </fieldset>
                <?php } ?>
            </form>
...
<script>
    ...
    setInterval(function () {
        ...
        if($('#name').val() === '' || $('#age').val() === '' || $('#country').val() === '' || $('#address').val() === '') {
            $('#doneButton').addClass('disabled');
            return;
        }

        var citezenship = $('[name="citizenship"]:checked').val();
        if(citezenship === 'china') {
            $('#restrictionText').show();
            $('#doneButton').addClass('disabled');
        } else {
            $('#restrictionText').hide();
        ...
        if(citezenship === 'usa') {
            ...
            $('[name="registration_data"]').val(JSON.stringify({
                name: $('#name').val(),
                age: $('#age').val(),
                country: $('#country').val(),
                address: $('#address').val(),
            ...
            $('.sign-up-form')[0].action = 'https://usa-sale.membrana.io/app/register';
            $('.checkbox5').show();
            ...
            $('.sign-up-form')[0].action = 'https://sale.membrana.io/app/register';
            $('.checkbox5').hide();
        }
