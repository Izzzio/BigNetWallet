        ...
        <div class="col-md-12">
            ...
            <div class="container">
                <div class="lk-main-list row">
                    <div class="lk-block top-block col-md-10" style="width: 100%">
                                ...
                                var id = idensic.init(
                                    '#idensic',
                                    {
                                        ...
                                        "uiConf": {
                                            "steps": {
                                                "PROOF_OF_PAYMENT": {
                                                    "title": "Accredited Investor Check",
                                                    "stepName": "Accredited Investor",
                                                    "instructions": "## <center>To evidence your accredited investor status as is required by federal law ([Rule 501 of Regulation D](https://www.ecfr.gov/cgi-bin/retrieveECFR?SID=8edfd12967d69c024485029d968ee737&gp=&n=17y3.0.1.1.12.0.46.176&r=SECTION)), please go through the following [instruction](https://www.dropbox.com/s/s9l93xmak1cjde0/Guide_Accredited_Investor_Check.pdf?dl=0). </center>"
                                                }
                                            }
                                        }
                                        /*
                                    ...
                                    */
                                    ...
                                    function (messageType, payload) {
                                        ...
                                        console.log('[IDENSIC] Idensic message:', messageType, payload);
